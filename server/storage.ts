...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    const sampleProducts: Product[] = [
      ...
      // Additional electrical products to showcase catalog
      {
        id: 5,
        name: "MCB 32A Single Pole",
        slug: "mcb-32a-single-pole",
        ...
        images: ["https://images.unsplash.com/photo-1621905251918-48416bd8575a?w=400&h=300&fit=crop"] as string[],
        unit: "piece",
        warranty: "2 years",
        taxHsn: "8536",
        isActive: true,
      ...
      },
      {
        ...
        images: ["https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?w=400&h=300&fit=crop"] as string[],
        unit: "piece",
        warranty: "2 years",
        taxHsn: "8414",
        isActive: true,
      ...
      },
      {
        ...
        slug: "extension-cord-10m",
        description: "Heavy duty extension cord with 4 outlets",
        sku: "EXT-10M-4OUT",
        brand: "Anchor",
        categoryId: 2,
        price: "899.00",
      ...
      {
        id: 9,
        name: "Soldering Iron 40W",
        slug: "soldering-iron-40w",
        description: "Professional soldering iron with stand",
        sku: "SI-40W-PRO",
        brand: "Weller",
        categoryId: 3,
        price: "799.00",
      ...
      {
        id: 10,
        name: "Smart Switch Wi-Fi",
        slug: "smart-switch-wifi",
        description: "Wi-Fi enabled smart switch with app control",
        sku: "SW-WIFI-SMART",
        brand: "Syska",
        categoryId: 1,
        price: "1599.00",
